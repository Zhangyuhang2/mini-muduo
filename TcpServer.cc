...
{
    LOG(LoggerLevel::INFO,"TcpServer::newConnection",NULL);
    ...
    LOG(LoggerLevel::INFO,"TcpServer::newConnection [%s] - new connection [%s] from %s\n",
    ...
    {
        LOG(LoggerLevel::ERROR,"sockets::getLocalAddr",NULL);
    }
...
{
    LOG(LoggerLevel::INFO,"TcpServer::removeConnectionInLoop [%s] - connection %s\n",
